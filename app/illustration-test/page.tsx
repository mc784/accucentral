  ...
  return (
    <div className="min-h-screen bg-slate-medical">
      ...
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-heading font-bold text-navy-500 text-center mb-4">
          VrikshaYoga Illustration Style Test
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-xl border-2 border-slate-200 p-8">
            <h2 className="text-2xl font-heading font-semibold text-navy-500 mb-4">
              Full Size Preview
            </h2>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border-2 border-slate-200 p-6">
              ...
              <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-xl font-heading font-semibold text-navy-500 mb-1">
                    Tree Pose
                  </h3>
            ...
            {/* Design notes */}
            <div className="bg-white rounded-xl border-2 border-navy-200 p-6">
              <h3 className="text-xl font-heading font-semibold text-navy-500 mb-4">
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-gold-300 mt-1">→</span>
                  <span><strong>Gold-to-Coral accent</strong> for energy/flow</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gold-300 mt-1">→</span>
        ...
        <div className="mt-12 max-w-5xl mx-auto">
          <h2 className="text-2xl font-heading font-bold text-navy-500 mb-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-heading font-semibold text-navy-500">
                    Tree Pose
                  </h3>
