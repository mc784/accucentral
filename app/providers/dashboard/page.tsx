...
import { providerOnboardingTour } from '@/lib/tours'
...
export default function ProviderDashboard() {
  ...
  const { 
    ...
    totalSteps, 
    isActive 
  } = useTour(providerOnboardingTour);

  useEffect(() => {
    const tourHasBeenSeen = localStorage.getItem(`tour_${providerOnboardingTour.id}_completed`);
    if (!tourHasBeenSeen) {
      start();
    }
  ...
  const handleTourFinish = () => {
    localStorage.setItem(`tour_${providerOnboardingTour.id}_completed`, 'true');
    stop();
  }

  const handleRestartTour = () => {
    localStorage.removeItem(`tour_${providerOnboardingTour.id}_completed`);
    start();
  }
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                <button 
                  ...
                  className="text-slate-gray hover:text-deep-teal font-medium transition-colors underline"
                >
                  Help Tour
                </button>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div id="tour-total-earnings" className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-warm-coral">
